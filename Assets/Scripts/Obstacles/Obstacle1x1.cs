...
public class Obstacle1x1 : Obstacle {

    public Obstacle1x1(GameObject[][] givenGrid, int posX, int posY) : base(givenGrid, posX, posY)
    {
        SizeOfObstacle = 1;
    }
    ...
    {
        if (posX < gridArray.Length && posY < gridArray[0].Length)
        {
